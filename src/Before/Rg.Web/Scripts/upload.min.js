!function(t,e){"use strict";t.ajaxPrefilter(function(t,e,a){return t.iframe?(t.originalURL=t.url,"iframe"):void 0}),t.ajaxTransport("iframe",function(e,a,n){function i(){l.each(function(e,a){var n=t(a);n.data("clone").replaceWith(n)}),o.remove(),r.one("load",function(){r.remove()}),r.attr("src","javascript:false;")}var o=null,r=null,d="iframe-"+t.now(),l=t(e.files).filter(":file:enabled"),u=null,c=null;return e.dataTypes.shift(),e.data=a.data,l.length?(o=t("<form enctype='multipart/form-data' method='post'></form>").hide().attr({action:e.originalURL,target:d}),"string"==typeof e.data&&e.data.length>0&&t.error("data must not be serialized"),t.each(e.data||{},function(e,a){t.isPlainObject(a)&&(e=a.name,a=a.value),t("<input type='hidden' />").attr({name:e,value:a}).appendTo(o)}),t("<input type='hidden' value='IFrame' name='X-Requested-With' />").appendTo(o),c=e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+("*"!==e.dataTypes[0]?", */*; q=0.01":""):e.accepts["*"],t("<input type='hidden' name='X-HTTP-Accept'>").attr("value",c).appendTo(o),u=l.after(function(e){var a=t(this),n=a.clone().prop("disabled",!0);return a.data("clone",n),n}).next(),l.appendTo(o),{send:function(e,a){r=t("<iframe src='javascript:false;' name='"+d+"' id='"+d+"' style='display:none'></iframe>"),r.one("load",function(){r.one("load",function(){var t=this.contentWindow?this.contentWindow.document:this.contentDocument?this.contentDocument:this.document,e=t.documentElement?t.documentElement:t.body,n=e.getElementsByTagName("textarea")[0],o=n&&n.getAttribute("data-type")||null,r=n&&n.getAttribute("data-status")||200,d=n&&n.getAttribute("data-statusText")||"OK",l={html:e.innerHTML,text:o?n.value:e?e.textContent||e.innerText:null};i(),a(r,d,l,o?"Content-Type: "+o:null)}),o[0].submit()}),t("body").append(o,r)},abort:function(){null!==r&&(r.unbind("load").attr("src","javascript:false;"),i())}}):void 0})}(jQuery);
...
function makeImageUploadTarget(e,a,p,n){"use strict";e.fileupload({url:"/api/UploadMedia",dropZone:a,acceptFileTypes:/(\.|\/)(gif|jpe?g|png)$/i,maxFileSize:999e3,maxNumberOfFiles:1}).on("fileuploadprocessalways",function(e,a){var p=a.index,n=a.files[p],o=$(a.context.children()[p]);n.preview&&o.prepend("<br>").prepend(n.preview),n.error&&o.append("<br>").append($('<span class="text-danger" />').text(n.error))}).on("fileuploadadd",function(e,a){a.context=$("<div />").appendTo("#files"),$.each(a.files,function(e,p){var n=$("<p />").append($("<span />").text(p.name));n.appendTo(a.context)})}).on("fileuploadprogressall",function(e,a){var p=parseInt(a.loaded/a.total*100,10);$("#progress .progress-bar").css("width",p+"%")}).on("fileuploaddone",n)}